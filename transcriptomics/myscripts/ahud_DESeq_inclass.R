...
hist(apply(countsTableRound,1,mean),xlim=c(0,1000), ylim=c(0,20000),breaks=10000)
...
# each of these contrasts were tested
...
# make a heatmap to look for outliers
...
# again see AH_F2_Rep2 as an outlier
...
# cleaner data visualizations
# easier to read by separating generations
###############################################################
